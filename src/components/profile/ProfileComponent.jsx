...
class ProfileComponent extends React.Component {
	...
	updateUser = (e) => {
		e.preventDefault();
		axios
			.put("http://localhost:4000/register/me", this.state, this.state.config)
				...
				<div className="row">
					...
					<div className="col-sm-8">
						<img
							...
							src="https://static-communitytable.parade.com/wp-content/uploads/2014/07/seasonal-produce-ftr.jpg"
						/>
					</div>
				</div>
			</div>
